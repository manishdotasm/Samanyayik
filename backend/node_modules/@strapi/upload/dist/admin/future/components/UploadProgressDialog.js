...
const HeaderStatusWrapper = styledComponents.styled(designSystem.Flex)`
  align-items: center;
`;
const HeaderStatus = ({ status, progress, totalFiles, successfulCount, errorCount })=>{
